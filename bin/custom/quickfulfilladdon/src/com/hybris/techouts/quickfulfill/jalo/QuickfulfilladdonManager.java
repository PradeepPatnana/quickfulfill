 ...
 */
package com.hybris.techouts.quickfulfill.jalo;
...
import com.hybris.techouts.quickfulfill.constants.QuickfulfilladdonConstants;



/**
 * This is the extension manager of the Quickfulfilladdon extension.
 */
public class QuickfulfilladdonManager extends GeneratedQuickfulfilladdonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(QuickfulfilladdonManager.class.getName());
	 ...
	 */
	public static QuickfulfilladdonManager getInstance()
	{
		return (QuickfulfilladdonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				QuickfulfilladdonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public QuickfulfilladdonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of QuickfulfilladdonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of QuickfulfilladdonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of QuickfulfilladdonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
