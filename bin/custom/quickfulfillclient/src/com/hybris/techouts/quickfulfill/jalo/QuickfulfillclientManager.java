...
/**
 * This is the extension manager of the Quickfulfillclient extension.
 */
public class QuickfulfillclientManager extends GeneratedQuickfulfillclientManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(QuickfulfillclientManager.class);
	 ...
	 */
	public static QuickfulfillclientManager getInstance()
	{
		return (QuickfulfillclientManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(QuickfulfillclientConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public QuickfulfillclientManager() // NOPMD 
	{
		LOG.debug("constructor of QuickfulfillclientManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of QuickfulfillclientManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of QuickfulfillclientManager called, current tenant: {}", getTenant().getTenantID());
	}
