...
public class DefaultQuickfulfillclientService implements QuickfulfillclientService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultQuickfulfillclientService.class);
	...
	{
		return DefaultQuickfulfillclientService.class.getResourceAsStream("/quickfulfillclient/sap-hybris-platform.png");
	}
