...
import com.hybris.techouts.quickfulfill.service.impl.DefaultQuickfulfillclientService;
 ...
 */
@IntegrationTest
public class DefaultQuickfulfillclientServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "quickfulfillclientPlatformLogo";

		// when
		final String logoUrl = quickfulfillclientService.getHybrisLogoUrl(logoCode);
