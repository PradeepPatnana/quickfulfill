...
@XmlType(propOrder =
{ "ussId", "EDD", "nextEDD", "isScheduled", "CODEligible" })
public class EDDInfoWsDTO
{
	 ...
	 *           the eDD to set
	 */
	public void setEDD(final String eDD)
	{
		EDD = eDD;
	}
	 ...
	 *           the nextEDD to set
	 */
	public void setNextEDD(final String nextEDD)
	{
	 ...
	 */
	public void setIsScheduled(final String isScheduled)
	{
	...
	/**
	 * @param cODEligible
	 *           the cODEligible to set
	 */
	public void setCODEligible(final String cODEligible)
	{
